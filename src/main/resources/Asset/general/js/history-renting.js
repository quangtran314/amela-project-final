...
function pushOn(n)
{
    ...
    page_prev.setAttribute("href","/viewContracts?page="+(page_prev.text-1));
    page_current.setAttribute("href","/viewContracts?page="+(page_current.text-1));
    page_next.setAttribute("href","/viewContracts?page="+(page_next.text-1));
